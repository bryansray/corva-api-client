...
class FeedClient:
    ...
    def post_v2_activities(self, body=None, query_parameters=None):
        path = "/v2/activities"
        return self._client.post(path, body=body, params=query_parameters)

    def delete_v2_activities_id(self, id, body=None, query_parameters=None):
        path = f"/v2/activities/{id}"
        return self._client.delete(path, body=body, params=query_parameters)

    def get_v2_activities_id(self, id, query_parameters=None):
        path = f"/v2/activities/{id}"
        return self._client.get(path, params=query_parameters)

    def patch_v2_activities_id(self, id, body=None, query_parameters=None):
        path = f"/v2/activities/{id}"
