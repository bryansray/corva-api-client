...
class ProjectsClient:
    ...
    def post_v2_projects(self, body=None, query_parameters=None):
        path = "/v2/projects"
        return self._client.post(path, body=body, params=query_parameters)

    def delete_v2_projects_id(self, id, body=None, query_parameters=None):
        path = f"/v2/projects/{id}"
        return self._client.delete(path, body=body, params=query_parameters)

    def get_v2_projects_id(self, id, query_parameters=None):
        path = f"/v2/projects/{id}"
        return self._client.get(path, params=query_parameters)

    def patch_v2_projects_id(self, id, body=None, query_parameters=None):
        path = f"/v2/projects/{id}"
        return self._client.patch(path, body=body, params=query_parameters)

    def post_v2_projects_id(self, id, body=None, query_parameters=None):
        path = f"/v2/projects/{id}"
        return self._client.post(path, body=body, params=query_parameters)
